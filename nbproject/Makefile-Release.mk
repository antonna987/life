...
${OBJECTDIR}/cell.o: cell.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cell.o cell.cpp

${OBJECTDIR}/field.o: field.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/field.o field.cpp

${OBJECTDIR}/life.o: life.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/life.o life.cpp
...
${OBJECTDIR}/row.o: row.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/row.o row.cpp
